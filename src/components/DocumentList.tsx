...
export const DocumentList: React.FC = () => {
    const { documents, deleteDocument, familyMembers } = useApp();
    ...
    const filteredDocs = documents.filter(doc => {
        ...
        const matchesMember = filterMember === 'all' || doc.memberId === filterMember;
            ...
            >
                <AnimatePresence>
                    {filteredDocs.map(doc => {
                        ...
                        const member = familyMembers.find(m => m.id === doc.memberId);
